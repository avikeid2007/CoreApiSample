using MyClientNamespace.RepoLocation;
using System;
...
namespace ClientAppConsole
{
    class Program
    {
        static async System.Threading.Tasks.Task Main(string[] args)
        {
            ...
            var res = await weatherForecastClient.GetAsync();
            foreach (var item in res)
            {
                Console.WriteLine($"{ item.Date}  temperature is {item.TemperatureC} ,{item.Summary}");
            }
            Console.WriteLine();
        }
    }
...
namespace MyClientNamespace.RepoLocation
{
